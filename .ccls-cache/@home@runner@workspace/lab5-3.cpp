...
int main()
{const double MembeerDiscount_Rate = 0.10;
 const double NonmemberDiscount_Rate = 0.05;
	...
	// substract discount, if appropriate
			...
			if (toupper(member) == 'Y')
				amtOwed -= amtOwed * MembeerDiscount_Rate;
 else
				amtOwed -= amtOwed * NonmemberDiscount_Rate;
